...
この度は、拡張にゃしぃフォント改二をダウンロードしていただき、
ありがとうございます。
...
1. 拡張にゃしぃフォント改二とは
拡張にゃしぃフォント改二は、
にゃしぃフォント改二（圧縮ファイル同封）の字形を
文字通り「拡張」するフォントです。

フォント制作における制約上、
これまで「メイン（＝にゃしぃフォント改二）」の
フォントファイルに収録しようとしても、できなかった漢字たち。
それらを救済すべく、拡張にゃしぃフォント改二はメインに対する
